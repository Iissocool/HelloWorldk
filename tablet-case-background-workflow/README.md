...
cd tablet-case-background-workflow
```
...
- 详细使用手册：[docs/桌面程序详细使用手册.md](C:\Users\F1736\Documents\New project\tablet-case-background-workflow\docs\桌面程序详细使用手册.md)
- 架构说明：[docs/architecture.md](C:\Users\F1736\Documents\New project\tablet-case-background-workflow\docs\architecture.md)
